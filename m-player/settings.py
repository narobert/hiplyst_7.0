# Django settings for m-player project.
...
STATIC_ROOT = os.path.join(ROOT_URL, "blog/static")
...
TEMPLATE_DIRS = (
    os.path.join(ROOT_URL, "blog/templates"),
)

# Absolute filesystem path to the directory that will hold user-uploaded files.
# Example: "/var/www/example.com/media/"
MEDIA_ROOT = os.path.join(ROOT_URL, "blog/static/media/")
...
SECRET_KEY = '0y%bglh(16-w(oeulif+whd8-+6yvc0r+(8-et4jyo&amp;==%5)z1'
...
ROOT_URLCONF = 'm-player.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'm-player.wsgi.application'
